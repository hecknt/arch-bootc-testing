...
>
> Fedora Atomic uses the ostree backend. This image is tested against the (currently experimental) [composefs backend](https://bootc-dev.github.io/bootc/experimental-composefs.html). Along with this fact, certain images (i.e any Universal Blue image such as [Bazzite](https://bazzite.gg)) will break when rebasing to this image for unrelated reasons.
>
> If you don't know what you're doing, <ins>**don't install this image.**</ins> You are likely better off with fedora based images such as [Zirconium](https://github.com/zirconium-dev/zirconium) if you want to use niri.
